...
#ifndef MODM_STM32_GPIO_PIN_E14_HPP
#define MODM_STM32_GPIO_PIN_E14_HPP
...
class GpioE14 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioE14>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioE14;
	using Input = GpioE14;
	using IO = GpioE14;
	using Type = GpioE14;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioE14::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct Ch4 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tim1),
			"GpioE14::Ch4 only connects to Tim1!");
	};
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioE14::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioE14;
...
template<>
struct GpioE14::Ch4<Peripheral::Tim1>
{
	using Gpio = GpioE14;
...
#endif // MODM_STM32_GPIO_PIN_E14_HPP