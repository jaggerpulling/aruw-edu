...
#ifndef MODM_STM32_GPIO_PIN_D13_HPP
#define MODM_STM32_GPIO_PIN_D13_HPP
...
class GpioD13 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioD13>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioD13;
	using Input = GpioD13;
	using IO = GpioD13;
	using Type = GpioD13;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioD13::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct A18 { static void connect();
		static_assert(
			(peripheral == Peripheral::Fmc),
			"GpioD13::A18 only connects to Fmc!");
	};
	template< Peripheral peripheral >
	struct Ch2 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tim4),
			"GpioD13::Ch2 only connects to Tim4!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioD13::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioD13;
...
template<>
struct GpioD13::A18<Peripheral::Fmc>
{
	using Gpio = GpioD13;
...
template<>
struct GpioD13::Ch2<Peripheral::Tim4>
{
	using Gpio = GpioD13;
...
#endif // MODM_STM32_GPIO_PIN_D13_HPP