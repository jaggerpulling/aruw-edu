...
#ifndef MODM_STM32_GPIO_PIN_H6_HPP
#define MODM_STM32_GPIO_PIN_H6_HPP
...
class GpioH6 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioH6>;
	friend class Adc;
...
/// @cond
template<>
struct GpioH6::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioH6;
...
template<>
struct GpioH6::Ch1<Peripheral::Tim12>
{
	using Gpio = GpioH6;
...
template<>
struct GpioH6::D8<Peripheral::Dcmi>
{
	using Gpio = GpioH6;
...
template<>
struct GpioH6::Rxd2<Peripheral::Eth>
{
	using Gpio = GpioH6;
...
template<>
struct GpioH6::Sck<Peripheral::Spi5>
{
	using Gpio = GpioH6;
...
template<>
struct GpioH6::Sdne1<Peripheral::Fmc>
{
	using Gpio = GpioH6;
...
template<>
struct GpioH6::Smba<Peripheral::I2c2>
{
	using Gpio = GpioH6;
...
#endif // MODM_STM32_GPIO_PIN_H6_HPP