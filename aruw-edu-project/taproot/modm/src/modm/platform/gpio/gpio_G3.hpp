...
#ifndef MODM_STM32_GPIO_PIN_G3_HPP
#define MODM_STM32_GPIO_PIN_G3_HPP
...
class GpioG3 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioG3>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioG3::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct A13 { static void connect();
		static_assert(
			(peripheral == Peripheral::Fmc),
			"GpioG3::A13 only connects to Fmc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioG3::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioG3;
...
template<>
struct GpioG3::A13<Peripheral::Fmc>
{
	using Gpio = GpioG3;
...
#endif // MODM_STM32_GPIO_PIN_G3_HPP