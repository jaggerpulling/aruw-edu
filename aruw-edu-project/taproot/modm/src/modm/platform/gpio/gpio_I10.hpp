...
#ifndef MODM_STM32_GPIO_PIN_I10_HPP
#define MODM_STM32_GPIO_PIN_I10_HPP
...
class GpioI10 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioI10>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioI10;
	using Input = GpioI10;
	using IO = GpioI10;
	using Type = GpioI10;
...
/// @cond
template<>
struct GpioI10::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioI10;
...
#endif // MODM_STM32_GPIO_PIN_I10_HPP