...
#ifndef MODM_STM32_GPIO_PIN_G9_HPP
#define MODM_STM32_GPIO_PIN_G9_HPP
...
class GpioG9 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioG9>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioG9::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioG9::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioG9;
...
template<>
struct GpioG9::Rx<Peripheral::Usart6>
{
	using Gpio = GpioG9;
...
#endif // MODM_STM32_GPIO_PIN_G9_HPP