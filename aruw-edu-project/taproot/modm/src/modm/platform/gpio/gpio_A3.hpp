...
public:
	...
	struct Ch2 { static void connect();
		static_assert(
			...
			"GpioA3::Ch2 only connects to Tim9!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct Ulpid0 { static void connect();
		static_assert(
			(peripheral == Peripheral::Usbotghs),
			"GpioA3::Ulpid0 only connects to Usbotghs!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioA3::Ch2<Peripheral::Tim9>
{
	using Gpio = GpioA3;
...
template<>
struct GpioA3::In3<Peripheral::Adc1>
{
	using Gpio = GpioA3;
...
template<>
constexpr int8_t
GpioA3::AdcChannel<Peripheral::Adc1> = 3;
template<>
struct GpioA3::In3<Peripheral::Adc2>
{
	using Gpio = GpioA3;
	static constexpr Gpio::Signal Signal = Gpio::Signal::In3;
	static constexpr int af = -1;
...
template<>
constexpr int8_t
GpioA3::AdcChannel<Peripheral::Adc2> = 3;
template<>
struct GpioA3::In3<Peripheral::Adc3>
{
	using Gpio = GpioA3;
	static constexpr Gpio::Signal Signal = Gpio::Signal::In3;
	static constexpr int af = -1;
...
template<>
constexpr int8_t
GpioA3::AdcChannel<Peripheral::Adc3> = 3;
template<>
...
template<>
struct GpioA3::Ulpid0<Peripheral::Usbotghs>
{
	using Gpio = GpioA3;
