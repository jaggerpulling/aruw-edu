...
#ifndef MODM_STM32_GPIO_PIN_G0_HPP
#define MODM_STM32_GPIO_PIN_G0_HPP
...
class GpioG0 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioG0>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioG0::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct A10 { static void connect();
		static_assert(
			(peripheral == Peripheral::Fmc),
			"GpioG0::A10 only connects to Fmc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioG0::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioG0;
...
template<>
struct GpioG0::A10<Peripheral::Fmc>
{
	using Gpio = GpioG0;
...
#endif // MODM_STM32_GPIO_PIN_G0_HPP