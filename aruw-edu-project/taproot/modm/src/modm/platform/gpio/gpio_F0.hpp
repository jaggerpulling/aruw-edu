...
#ifndef MODM_STM32_GPIO_PIN_F0_HPP
#define MODM_STM32_GPIO_PIN_F0_HPP
...
class GpioF0 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioF0>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioF0::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	...
	struct Sda { static void connect();
		static_assert(
			...
			"GpioF0::Sda only connects to I2c2!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioF0::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioF0;
...
template<>
struct GpioF0::Sda<Peripheral::I2c2>
{
	using Gpio = GpioF0;
...
#endif // MODM_STM32_GPIO_PIN_F0_HPP