...
#ifndef MODM_STM32_GPIO_PIN_I2_HPP
#define MODM_STM32_GPIO_PIN_I2_HPP
...
class GpioI2 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioI2>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioI2::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	...
	struct Miso { static void connect();
		static_assert(
			...
			"GpioI2::Miso only connects to Spi2!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioI2::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioI2;
...
template<>
struct GpioI2::Ch4<Peripheral::Tim8>
{
	using Gpio = GpioI2;
...
template<>
struct GpioI2::Miso<Peripheral::Spi2>
{
	using Gpio = GpioI2;
...
#endif // MODM_STM32_GPIO_PIN_I2_HPP