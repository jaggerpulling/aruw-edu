...
#ifndef MODM_STM32_GPIO_PIN_H5_HPP
#define MODM_STM32_GPIO_PIN_H5_HPP
...
class GpioH5 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioH5>;
	friend class Adc;
...
/// @cond
template<>
struct GpioH5::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioH5;
...
#endif // MODM_STM32_GPIO_PIN_H5_HPP