...
#ifndef MODM_STM32_GPIO_PIN_G1_HPP
#define MODM_STM32_GPIO_PIN_G1_HPP
...
class GpioG1 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioG1>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioG1::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct A11 { static void connect();
		static_assert(
			(peripheral == Peripheral::Fmc),
			"GpioG1::A11 only connects to Fmc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioG1::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioG1;
...
template<>
struct GpioG1::A11<Peripheral::Fmc>
{
	using Gpio = GpioG1;
...
#endif // MODM_STM32_GPIO_PIN_G1_HPP