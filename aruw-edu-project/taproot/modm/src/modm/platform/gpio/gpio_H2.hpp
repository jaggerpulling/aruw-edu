...
#ifndef MODM_STM32_GPIO_PIN_H2_HPP
#define MODM_STM32_GPIO_PIN_H2_HPP
...
class GpioH2 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioH2>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioH2::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioH2::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioH2;
...
template<>
struct GpioH2::Crs<Peripheral::Eth>
{
	using Gpio = GpioH2;
...
#endif // MODM_STM32_GPIO_PIN_H2_HPP