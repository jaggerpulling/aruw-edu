...
#ifndef MODM_STM32_GPIO_PIN_I6_HPP
#define MODM_STM32_GPIO_PIN_I6_HPP
...
class GpioI6 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioI6>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioI6::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	...
	struct D6 { static void connect();
		static_assert(
			...
			"GpioI6::D6 only connects to Dcmi!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioI6::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioI6;
...
template<>
struct GpioI6::Ch2<Peripheral::Tim8>
{
	using Gpio = GpioI6;
...
template<>
struct GpioI6::D6<Peripheral::Dcmi>
{
	using Gpio = GpioI6;
...
#endif // MODM_STM32_GPIO_PIN_I6_HPP