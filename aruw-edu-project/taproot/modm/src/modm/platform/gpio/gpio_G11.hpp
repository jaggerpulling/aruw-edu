...
#ifndef MODM_STM32_GPIO_PIN_G11_HPP
#define MODM_STM32_GPIO_PIN_G11_HPP
...
class GpioG11 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioG11>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioG11;
	using Input = GpioG11;
	using IO = GpioG11;
	using Type = GpioG11;
...
/// @cond
template<>
struct GpioG11::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioG11;
...
#endif // MODM_STM32_GPIO_PIN_G11_HPP