...
#ifndef MODM_STM32_GPIO_PIN_H7_HPP
#define MODM_STM32_GPIO_PIN_H7_HPP
...
class GpioH7 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioH7>;
	friend class Adc;
...
/// @cond
template<>
struct GpioH7::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioH7;
...
template<>
struct GpioH7::D9<Peripheral::Dcmi>
{
	using Gpio = GpioH7;
...
template<>
struct GpioH7::Miso<Peripheral::Spi5>
{
	using Gpio = GpioH7;
...
template<>
struct GpioH7::Rxd3<Peripheral::Eth>
{
	using Gpio = GpioH7;
...
template<>
struct GpioH7::Scl<Peripheral::I2c3>
{
	using Gpio = GpioH7;
...
template<>
struct GpioH7::Sdcke1<Peripheral::Fmc>
{
	using Gpio = GpioH7;
...
#endif // MODM_STM32_GPIO_PIN_H7_HPP