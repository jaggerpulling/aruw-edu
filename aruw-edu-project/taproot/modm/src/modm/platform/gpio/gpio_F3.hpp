...
#ifndef MODM_STM32_GPIO_PIN_F3_HPP
#define MODM_STM32_GPIO_PIN_F3_HPP
...
class GpioF3 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioF3>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioF3::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	...
	struct In9 { static void connect();
		static_assert(
			...
			"GpioF3::In9 only connects to Adc3!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioF3::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioF3;
...
template<>
struct GpioF3::In9<Peripheral::Adc3>
{
	using Gpio = GpioF3;
...
template<>
constexpr int8_t
GpioF3::AdcChannel<Peripheral::Adc3> = 9;
/// @endcond

} // namespace modm::platform

#endif // MODM_STM32_GPIO_PIN_F3_HPP