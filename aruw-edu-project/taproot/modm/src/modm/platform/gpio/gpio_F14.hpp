...
#ifndef MODM_STM32_GPIO_PIN_F14_HPP
#define MODM_STM32_GPIO_PIN_F14_HPP
...
class GpioF14 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioF14>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioF14;
	using Input = GpioF14;
	using IO = GpioF14;
	using Type = GpioF14;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioF14::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct A8 { static void connect();
		static_assert(
			(peripheral == Peripheral::Fmc),
			"GpioF14::A8 only connects to Fmc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioF14::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioF14;
...
template<>
struct GpioF14::A8<Peripheral::Fmc>
{
	using Gpio = GpioF14;
...
#endif // MODM_STM32_GPIO_PIN_F14_HPP