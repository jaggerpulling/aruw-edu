...
#ifndef MODM_STM32_GPIO_PIN_G2_HPP
#define MODM_STM32_GPIO_PIN_G2_HPP
...
class GpioG2 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioG2>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioG2::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct A12 { static void connect();
		static_assert(
			(peripheral == Peripheral::Fmc),
			"GpioG2::A12 only connects to Fmc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioG2::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioG2;
...
template<>
struct GpioG2::A12<Peripheral::Fmc>
{
	using Gpio = GpioG2;
...
#endif // MODM_STM32_GPIO_PIN_G2_HPP