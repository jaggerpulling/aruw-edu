...
#ifndef MODM_STM32_GPIO_PIN_F13_HPP
#define MODM_STM32_GPIO_PIN_F13_HPP
...
class GpioF13 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioF13>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioF13;
	using Input = GpioF13;
	using IO = GpioF13;
	using Type = GpioF13;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioF13::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct A7 { static void connect();
		static_assert(
			(peripheral == Peripheral::Fmc),
			"GpioF13::A7 only connects to Fmc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioF13::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioF13;
...
template<>
struct GpioF13::A7<Peripheral::Fmc>
{
	using Gpio = GpioF13;
...
#endif // MODM_STM32_GPIO_PIN_F13_HPP