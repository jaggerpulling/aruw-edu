...
#ifndef MODM_STM32_GPIO_PIN_F15_HPP
#define MODM_STM32_GPIO_PIN_F15_HPP
...
class GpioF15 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioF15>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioF15;
	using Input = GpioF15;
	using IO = GpioF15;
	using Type = GpioF15;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioF15::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct A9 { static void connect();
		static_assert(
			(peripheral == Peripheral::Fmc),
			"GpioF15::A9 only connects to Fmc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioF15::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioF15;
...
template<>
struct GpioF15::A9<Peripheral::Fmc>
{
	using Gpio = GpioF15;
...
#endif // MODM_STM32_GPIO_PIN_F15_HPP