...
#ifndef MODM_STM32_GPIO_PIN_I4_HPP
#define MODM_STM32_GPIO_PIN_I4_HPP
...
class GpioI4 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioI4>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioI4::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct Bkin { static void connect();
		static_assert(
			(peripheral == Peripheral::Tim8),
			"GpioI4::Bkin only connects to Tim8!");
	};
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioI4::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioI4;
...
template<>
struct GpioI4::Bkin<Peripheral::Tim8>
{
	using Gpio = GpioI4;
...
template<>
struct GpioI4::D5<Peripheral::Dcmi>
{
	using Gpio = GpioI4;
...
#endif // MODM_STM32_GPIO_PIN_I4_HPP