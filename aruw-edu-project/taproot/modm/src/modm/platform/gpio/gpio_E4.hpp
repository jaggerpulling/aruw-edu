...
#ifndef MODM_STM32_GPIO_PIN_E4_HPP
#define MODM_STM32_GPIO_PIN_E4_HPP
...
class GpioE4 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioE4>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioE4::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	...
	struct Traced1 { static void connect();
		static_assert(
			...
			"GpioE4::Traced1 only connects to Sys!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioE4::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioE4;
...
template<>
struct GpioE4::D4<Peripheral::Dcmi>
{
	using Gpio = GpioE4;
...
template<>
struct GpioE4::Traced1<Peripheral::Sys>
{
	using Gpio = GpioE4;
...
#endif // MODM_STM32_GPIO_PIN_E4_HPP