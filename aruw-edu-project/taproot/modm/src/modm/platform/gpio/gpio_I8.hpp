...
#ifndef MODM_STM32_GPIO_PIN_I8_HPP
#define MODM_STM32_GPIO_PIN_I8_HPP
...
class GpioI8 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioI8>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioI8::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct Af2 { static void connect();
		static_assert(
			(peripheral == Peripheral::Rtc),
			"GpioI8::Af2 only connects to Rtc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioI8::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioI8;
...
template<>
struct GpioI8::Af2<Peripheral::Rtc>
{
	using Gpio = GpioI8;
...
#endif // MODM_STM32_GPIO_PIN_I8_HPP