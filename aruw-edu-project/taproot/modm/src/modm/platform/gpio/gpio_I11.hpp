...
#ifndef MODM_STM32_GPIO_PIN_I11_HPP
#define MODM_STM32_GPIO_PIN_I11_HPP
...
class GpioI11 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioI11>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioI11;
	using Input = GpioI11;
	using IO = GpioI11;
	using Type = GpioI11;
...
/// @cond
template<>
struct GpioI11::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioI11;
...
#endif // MODM_STM32_GPIO_PIN_I11_HPP