...
#ifndef MODM_STM32_GPIO_PIN_F12_HPP
#define MODM_STM32_GPIO_PIN_F12_HPP
...
class GpioF12 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioF12>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioF12;
	using Input = GpioF12;
	using IO = GpioF12;
	using Type = GpioF12;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioF12::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct A6 { static void connect();
		static_assert(
			(peripheral == Peripheral::Fmc),
			"GpioF12::A6 only connects to Fmc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioF12::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioF12;
...
template<>
struct GpioF12::A6<Peripheral::Fmc>
{
	using Gpio = GpioF12;
...
#endif // MODM_STM32_GPIO_PIN_F12_HPP